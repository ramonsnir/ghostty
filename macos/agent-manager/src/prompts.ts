...
export const SUMMARIZER_BASE_PROMPT = [
  ...
  "  Then decide, from the CURRENT bottom-of-screen state, whether this bell should pull",
  "  the user in NOW: true if they need to act or would want to know immediately (a",
  "  question / approval / choice / error awaiting them, a finished task they were waiting",
  "  on); false if it is incidental (a background task or workflow just started — e.g.",
  "  \"running in the background\" — a sub-step finished, a routine notification). When no",
  "  bell-rang note is present, OMIT attention entirely. Judge the live state, not",
  "  scrollback. Use the agent state hint (working often ⇒ incidental).",
